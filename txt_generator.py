...
valid_dir = f'C:/Users/HNU/Documents/github/ObjectDetection_Flutter/datasets/valid/images/*'
...
with open('C:/Users/HNU/Documents/github/ObjectDetection_Flutter/datasets/valid.txt', 'w') as f:
    f.write('\n'.join(valid_data) + "\n")
